<?php
	...
	if($page == 'add'){
		...
		if($rows == 0)
		{
			$query3 = "INSERT INTO tblpatient2counsel(PatientID,CounselID,Initiate,InitiateDateTime,InitiatePSC,`Match`,MatchDateTime,MatchPSC,LockedBy,`SearchRelationship`, `SearchSex`, `SearchAge`, `SearchCurrentCancer`, `SearchCancerStage`, `SearchMetastasisHistory`, `SearchMetastasisBodyPart`, `SearchCancerRecurrance`, `SearchCancerHistory`, `SearchOtherHealthProblems`, `SearchChemotherapy`, `SearchChemotherapySE`, `SearchOtherDrugs`, `SearchOtherDrugsSE`, `SearchRadiation`, `SearchRadiationSE`, `SearchSurgery`, `SearchSurgerySE`, `SearchSpecial`, `SearchSpecialSE`, `SearchComplementary`, `SearchComplementarySE`, `SearchLanguage`, `SearchMaritalStatus`, `SearchChildren`, `SearchWorkStatus`, `SearchRace`, `SearchReligion`, `SearchFace2Face`, `SearchSupportType`) 
