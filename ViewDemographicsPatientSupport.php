...
<html lang="en">
    <head>
        ...
        <title>CHNMS| Patient Support Person Info</title>
                            ...
                            <div class="panel panel-primary" id="patient_information">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h3>Patient Support Person Information</h3>
                                    </div>
                                    ...
                                    <div class="row"> <!--ROW 1-->
                                        ...
                                        <div class="col-md-6">                                          
                                            <div class="well well-sm">
                                                <h4>Patient Support Person Contact Information</h4>
                                            </div>                          
                                        </div>
        ...
        <script src="assets/js/cancerhopeJS/patient_support.js"></script>
