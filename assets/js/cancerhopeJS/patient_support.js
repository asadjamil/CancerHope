            ...
            */
            ...
            // PatientTypeID = 2 for PatientSupport Info 
            var PatientTypeID = 2;
                    ...
                    /* make ajax hit to findPatientResponse.php
                     ...
                     $.ajax({
                        ...
                        success:function(data){
                            ...
                            $('#sp_status').val(SupportPersonStatusName);
                            ...
                            if(EditFlag)
                            {
                                ...
                                if (answer){
                                       $.ajax({
                                        ...
                                        data:{FirstName:FirstName,LastName:LastName,Address:Address,City:City,State:State,ZIP:ZIP,Country:Country,HomePhone:HomePhone,BusPhone:BusPhone,GenderName:GenderName,Comments:Comments,PatientID:PatientID,OtherPhone:OtherPhone,EmailAddr:EmailAddr,DOB:DOB,Age:Age,AgeAtIlliness:AgeAtIlliness,SupportPersonStatusName:SupportPersonStatusName,StartDate:StartDate,EndDate:EndDate,DateOfInitialTraining:DateOfInitialTraining,PreferredActivityLevel:PreferredActivityLevel,PatientTypeID:PatientTypeID},
                                        success:function(data){
                                            //alert('S');
                                            //alert(data);
