...
var Sex_ON;
var Age_ON;
var CurrentCancer_ON;
var CancerStage_ON;
var MetastasisHistory_ON;
var MetastasisBodyPart_ON;
var CancerRecurrance_ON;
var CancerHistory_ON;
var OtherHealthProblems_ON;
var Chemotherapy_ON;
var ChemotherapySE_ON;
var OtherDrugs_ON;
var OtherDrugsSE_ON;
var Radiation_ON;
var RadiationSE_ON;
...
var Special_ON;
var SpecialSE_ON;
var Complementary_ON;
var ComplementarySE_ON;
var Language_ON;
var MaritalStatus_ON;
var Children_ON;
var WorkStatus_ON;
var Race_ON;
var Religion_ON;
...
$(document).ready(function(){ 
    ...
    */    
    $(document).on('click','li.patient-names',function(){ 
        ...
        // Save Match Name which means make Base entry in P2C table
        saveMatchName(id);    
...
function AddMatchFlag(cid)
{
    // get CounselID in 'cid' from param (id)
    var cid = cid;
    // get PatientID from search field
    var pid = id;
    var p = 'add';
    var Match = 1;
    //alert(cid);
    ...
    //alert(Sex_ON);
    $.ajax({
        url:"AddMatchFlag.php",
        method:"POST",
        data:{p:p,cid:cid,pid:pid,Match:Match,Relationship_ON:Relationship_ON,Sex_ON:Sex_ON,Age_ON:Age_ON,CurrentCancer_ON:CurrentCancer_ON,CancerStage_ON:CancerStage_ON,MetastasisHistory_ON:MetastasisHistory_ON,MetastasisBodyPart_ON:MetastasisBodyPart_ON,CancerRecurrance_ON:CancerRecurrance_ON,CancerHistory_ON:CancerHistory_ON,OtherHealthProblems_ON:OtherHealthProblems_ON,Chemotherapy_ON:Chemotherapy_ON,ChemotherapySE_ON:ChemotherapySE_ON,OtherDrugs_ON:OtherDrugs_ON,OtherDrugsSE_ON:OtherDrugsSE_ON,Radiation_ON:Radiation_ON,RadiationSE_ON:RadiationSE_ON,Surgery_ON:Surgery_ON,SurgerySE_ON:SurgerySE_ON,Special_ON:Special_ON,SpecialSE_ON:SpecialSE_ON,Complementary_ON:Complementary_ON,ComplementarySE_ON:ComplementarySE_ON,Language_ON:Language_ON,MaritalStatus_ON:MaritalStatus_ON,Children_ON:Children_ON,WorkStatus_ON:WorkStatus_ON,Race_ON:Race_ON,Religion_ON:Religion_ON,Face2Face_ON:Face2Face_ON,SupportType_ON:SupportType_ON},
        success:function(data){
          //viewMatchName(pid);
          //alert(data);
        }
...
function AddLinkFlag(cid)
{
    ...
    $.ajax({
        url:"AddLinkFlag.php",
        method:"POST",
        data:{p:p,cid:cid,pid:pid,LinkFlag:LinkFlag,Relationship_ON:Relationship_ON,Sex_ON:Sex_ON,Age_ON:Age_ON,CurrentCancer_ON:CurrentCancer_ON,CancerStage_ON:CancerStage_ON,MetastasisHistory_ON:MetastasisHistory_ON,MetastasisBodyPart_ON:MetastasisBodyPart_ON,CancerRecurrance_ON:CancerRecurrance_ON,CancerHistory_ON:CancerHistory_ON,OtherHealthProblems_ON:OtherHealthProblems_ON,Chemotherapy_ON:Chemotherapy_ON,ChemotherapySE_ON:ChemotherapySE_ON,OtherDrugs_ON:OtherDrugs_ON,OtherDrugsSE_ON:OtherDrugsSE_ON,Radiation_ON:Radiation_ON,RadiationSE_ON:RadiationSE_ON,Surgery_ON:Surgery_ON,SurgerySE_ON:SurgerySE_ON,Special_ON:Special_ON,SpecialSE_ON:SpecialSE_ON,Complementary_ON:Complementary_ON,ComplementarySE_ON:ComplementarySE_ON,Language_ON:Language_ON,MaritalStatus_ON:MaritalStatus_ON,Children_ON:Children_ON,WorkStatus_ON:WorkStatus_ON,Race_ON:Race_ON,Religion_ON:Religion_ON,Face2Face_ON:Face2Face_ON,SupportType_ON:SupportType_ON},
        success:function(data){
          //viewMatchName(pid);
          alert(data);
        }
