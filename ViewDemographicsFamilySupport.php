...
<html lang="en">
    <head>
        ...
        <title>CHNMS| Family Support Person Info</title>
                            ...
                            <div class="panel panel-primary" id="patient_information">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h3>Family Support Person Information</h3>
                                    </div>
                                ...
                                <div class="tab-content">
                                  <div id="demographics" class="tab-pane active">
                                    ...
                                    <div class="row"> <!--ROW 1-->
                                        ...
                                        <div class="col-md-6">                                          
                                            <div class="well well-sm">
                                                <h4>Family Support Person Contact Information</h4>
                                            </div>                          
                                        </div>
                                        
                                        <div class="col-md-6">                                          
                                            <div class="well well-sm">
                                                <h4>Family Support Information</h4>
                                            </div>                                                                              
                                        </div>
                                    </div>
                                    ...
                                    <div class="row"> <!-- ROW 3 -->
                                        ...
                                        <div class="col-md-3">
                                            <label class="control-label" for="pstatus">Patient Status</label>
                                    ...
                                    <div class="row"> <!-- ROW 8 --> 
                                        <div class="col-md-12">
                                            <div class="well well-sm">
                                                <h4>Family Support Person Vitals</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <br/>
                                    ...
                                    <div class="row"> <!-- ROW 9  --> 
                                        ...
                                        <div class="col-sm-1"> 
                                            ...
                                            <input class="form-control" name="age" id="age" placeholder="" type="text">
                                        </div>
        ...
        <script src="assets/js/cancerhopeJS/family_support.js"></script>
